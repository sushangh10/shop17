...
<body>
 <div class="mianCont">
  ...
  <div class="pnt">
   ...
   <div class="pntRight">
    <ul class="nav">
     ...
     <li class="navCur"><a href="product.html">搜索商品</a></li>
  ...
  <div class="positions">
   当前位置：<a href="index">首页</a> &gt; <a href="#" class="posCur">搜索商品</a>
  </div><!--positions/-->
  ...
  <div class="jilu">
   ...
   <div class="contRight">
    ...
    <c:forEach items="${requestScope.search_product}" var="product">
    <dl>
      <dt><a href="${pageContext.request.contextPath}/productInfo?pid=${product.pid}&currentPage=${pageBean.currentPage}&cid=${cid}"> <img src="${pageContext.request.contextPath}/${product.pimage}"
				width="132" height="129" style="display: inline-block;">
			</a></dt>
      <dd>${product.pname}</dd>
