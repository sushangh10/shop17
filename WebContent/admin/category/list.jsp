						...
						<c:forEach items="${sessionScope.categories}" var="category">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="18%" name="cid" >${category.cid}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="17%">${category.cname}</td>
								<td align="center" style="HEIGHT: 22px">
									
								 
								<input type="text" name="cname" size="5" >
								<a href="${pageContext.request.contextPath}/adminCategoryUpdateServlet">
										<!-- <img
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="">
									        	<!--  <img href="${pageContext.request.contextPath}/images/i_del.gif"
