...
<body>
 <div class="mianCont">
  ...
  <div class="pnt">
   ...
   <div class="pntRight">
    <ul class="nav">
     ...
     <li class="navCur"><a href="product.html">我的足迹</a></li>
  ...
  <div class="positions">
   当前位置：<a href="index">首页</a> &gt; <a href="#" class="posCur">我的足迹</a>
  </div><!--positions/-->
  ...
  <div class="jilu">
   ...
   <div class="contRight">
    ...
    <c:forEach items="${requestScope.historyList}" var="history">
    	<dl>
      		<%-- <dt><a href="${pageContext.request.contextPath}/productInfo?pid=${product.pid}"><img src="${pageContext.request.contextPath }/${history.pimage}" width="132" height="129" /></a></dt>
      		<dd>${product.pname} </dd>
      		<dd class="cheng">店铺价:${product.shop_price} <span>￥${product.market_price}</span></dd> --%>
      		<dt><img src="${pageContext.request.contextPath }/${history.pimage}" width="132" height="129" /></dt>
     	</dl>
    </c:forEach>
    <div class="clears"></div>
    </div><!--frProList-->
